...
date: 2019-03-13
description: "Implementations of merge sort, quick sort, binary search, BFS, DFS, and Dijkstra's algorithm in Python."
tags: [python]
---
...
![graph bfs](/assets/img/graph-bfs.png)
...
![graph dfs](/assets/img/graph-dfs.png)
...
![graph weighted](/assets/img/graph-weighted.png)
