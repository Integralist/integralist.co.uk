...
- [Lookup Process](#lookup-process)
  - [Resolver](#resolver)
  - [Root Name Server(s)](#root-name-servers)
  - [TLD Name Server(s)](#tld-name-servers)
  - [SLD Name Server(s)](#sld-name-servers)
- [Tree Hierarchy](#tree-hierarchy)
- [DNS Structure](#dns-structure)
- [Authority Zones](#authority-zones)
- [Name Servers](#name-servers)
- [Commands](#commands)
  - [whois](#whois)
  - [dig](#dig)
      - [Flags](#flags)
      - [option: nostats](#option-nostats)
      - [option: nocomments](#option-nocomments)
