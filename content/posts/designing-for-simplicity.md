...
date: 2015-03-30
description: Lessons from building high-traffic systems at BBC News on complexity, caching, automation, and keeping software simple.
...
If you're interested in understanding thread safety (and the different concurrency abstractions) in more detail then I recommend you take a read of the following article "[Thread Safe Concurrency](/posts/concurrency/)".
...
![Bad Architecture](/assets/img/bad-architecture.png)
...
![Better Architecture](/assets/img/chintz-specification.png)
...
![Better Architecture](/assets/img/rpm-libraries.png)
...
Immutability is the key to avoiding complex mutexes and semaphores when writing multi-threaded code. To find out more on the subject please take a read of ["Thread Safe Concurrency"](/posts/concurrency/).
