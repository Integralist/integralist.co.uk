...
<a href="../../images/overview-actions-simple.png">
    <img src="../../images/overview-actions-simple.png">
</a>
<p></p>
...
2. **Variable reference**: `$VARNAME` (e.g. `echo $LITERAL`).
...
2. Artifact ([`actions/upload-artifact`](https://github.com/actions/upload-artifact), [`actions/download-artifact`](https://github.com/actions/download-artifact))
3. Job Output ([`outputs` documenation](https://docs.github.com/en/actions/learn-github-actions/workflow-syntax-for-github-actions#jobsjob_idoutputs))
