...
date: 2015-11-18
description: How to configure multiple SSH keys on one machine to work with separate GitHub accounts.
...
When cloning a repo from GitHub you will typically create an [SSH Key Pair](/posts/security-basics/#creating-your-own-keys) and paste the contents of the public key into your GitHub account via their web site. When you come to clone a repo you'll also typically use the SSH variation of the path:
