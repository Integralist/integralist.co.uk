...
date: 2019-09-04
description: Tools and techniques for limiting your online exposure, covering encrypted DNS, VPNs, Tor, and browser privacy.
...
![firefox addons](/assets/img/firefox-addons.png)
...
![firefox noscript example](/assets/img/firefox-noscript-example.png)

Below is a screenshot of what the 'uBlock' add-on looks like when visiting `google.com`:

![firefox ublock example](/assets/img/firefox-ublock-example.png)

Below is a screenshot of what the 'DuckDuckGo Privacy Essentials' add-on looks like:

![firefox duckduckgo](/assets/img/firefox-duckduckgo.png)
...
![firefox security strict](/assets/img/firefox-security-strict.png)
...
![firefox do not track](/assets/img/firefox-do-not-track.png)

Below is a screenshot of what Firefox looks like when inspecting a web page that has had content blocked:

![firefox content blocking](/assets/img/firefox-content-blocking.png)
...
![firefox data collection](/assets/img/firefox-data-collection.png)
